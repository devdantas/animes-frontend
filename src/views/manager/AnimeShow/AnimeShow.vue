      ...
      <div class="row mt-5">
        <div class="col-sm-12 col-lg-12 col-md-12">
          <div class="comments p-2">
            <vue-disqus shortname="animesfree" :title="this.specific.name" :identifier="this.slug" v-bind:url="'https://animesonline-4e7d1.firebaseapp.com/animes/'+this.slug"></vue-disqus>
          </div>
        </div>
      </div>
      <!-- #fim comment -->
